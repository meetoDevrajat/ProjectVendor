...
<table class="table">
 ...
 <tbody>
   ...
   <c:forEach var ="tempbook" items = "${product}">
   
   <c:url var= "updateLink" value="/product/updateForm">
  		<c:param name="id" value="${tempbook.id}"></c:param>
  	</c:url>
  
  <c:url var = "deleteLink" value="/product/deleteForm">
  ...
  <c:param name="id" value="${tempbook.id}"></c:param>
   ...
   <tr>
    ...
    <td>${tempbook.brand}</td>
    <td>${tempbook.category}</td>
    <td>${tempbook.description}</td>
    <td>${tempbook.name}</td>
    <td>${tempbook.price}</td>
    <td>${tempbook.rating}</td>
   <td>
   
<td>   <a href="${viewLink}"><button class="btn btn-light">View</button></a></td>
<td>    <a href="${updateLink}"><button class="btn btn-primary">Update</button></a></td>
  <td>  <a href="${deleteLink}"><button class="btn btn-Danger">Delete</button></a></td>
      ...
      <a href="showForm"><input type="button" value="Add Product" class="btn btn-dark" /></a>
         </div>
         </div>

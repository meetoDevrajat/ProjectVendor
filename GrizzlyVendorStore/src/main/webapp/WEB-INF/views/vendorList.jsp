...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li>  <a href="<c:url value='/vendor/logout' />"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
  </div>
</nav>
...
<table class="table">
 ...
 <tbody>
   ...
   <c:forEach var ="tempproduct" items = "${vendor}">
  ...
  <c:param name="id" value="${tempproduct.id}"></c:param>
   ...
   <tr>
    ...
    <td>${tempproduct.location}</td>
    <td>${tempproduct.contact}</td>
